...
function Profile() {
  ...
  useEffect(() => {
    ...
    if (sessionStorage.getItem('token')) {
      ...
      setUserss({
        id: userDetails._id, username: userDetails.username, email: userDetails.email, password: userDetails.password, Profile: ""
              ...
              <div className='p-5 border shadow border-3 m-3 ' style={{ width: '400px', height: '600px' }}>
                ...
                <div>
                  <label >
                    ...
                    {
                      existingProfile=="" ?
                        <img src={preview ? preview : "https://www.pngkey.com/png/full/115-1150152_default-profile-picture-avatar-png-green.png"} alt="iii" className='img-fluid' width={'150px'} />
